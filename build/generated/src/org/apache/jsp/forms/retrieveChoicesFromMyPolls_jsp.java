...
public final class retrieveChoicesFromMyPolls_jsp extends org.apache.jasper.runtime.HttpJspBase
      ...
      out.write("        ");
            ...
            try{
                ...
                while (result.next()){
                    ...
                    ret += ("Title:<t>" + "<input type=\"text\" value=\"" + choiceTitle + "\"></br>Description:<input type=\"text\" value=\"" + choiceDescription 
                    + "\"></br>");
